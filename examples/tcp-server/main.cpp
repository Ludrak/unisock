...
int main()
{
    ...
    server.on<CLOSED>([](tcp::server::server_connection* conn){
        std::cout << "server connection closed: " << socket_address::get_ip(conn->address) << std::endl;
    });
