...
using client = unisock::tcp::_lib::client_impl<std::tuple<>>;


/* type alias to get a client with some additionnal data  */
template<typename ..._ConnectionData>
using client_of = unisock::tcp::_lib::client_impl<std::tuple<>, _ConnectionData...>;
...
class client_impl<std::tuple<_Actions...>, _Data...> :  
                ...
                >
{
        using container_type = unisock::tcp::_lib::common_impl<_lib::client_actions<connection<_Data...>, _Actions...>, _Data...>;
...
template<typename ..._Actions, typename ..._Data>
inline bool tcp::_lib::client_impl<std::tuple<_Actions...>, _Data...>::on_client_receive(connection<_Data...>& socket)
{
...
// (i.e. on received)
template<typename ..._Actions, typename ..._Data>
inline bool    tcp::_lib::client_impl<std::tuple<_Actions...>, _Data...>::on_receive(unisock::_lib::socket_wrap* sptr)
{
    assert(sptr != nullptr);
